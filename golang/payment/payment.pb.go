...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\abill_id\x18\x02 \x01(\x03R\x06billId2I\n" +
	"\aPayment\x12>\n" +
	"\rCreatePayment\x12\x15.CreatePaymentRequest\x1a\x16.CreatePaymentResponseB8Z6github/joanaeliseal/microservices-proto/golang/paymentb\x06proto3"
...
var file_payment_payment_proto_depIdxs = []int32{
	...
	1, // 1: Payment.CreatePayment:output_type -> CreatePaymentResponse
