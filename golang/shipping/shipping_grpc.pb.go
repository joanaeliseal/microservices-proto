...
const (
	Shipping_Ship_FullMethodName = "/shipping.Shipping/Ship"
)
...
type ShippingClient interface {
	Ship(ctx context.Context, in *ShipOrderRequest, opts ...grpc.CallOption) (*ShipOrderResponse, error)
}
...
func (c *shippingClient) Ship(ctx context.Context, in *ShipOrderRequest, opts ...grpc.CallOption) (*ShipOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShipOrderResponse)
	err := c.cc.Invoke(ctx, Shipping_Ship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServer interface {
	Ship(context.Context, *ShipOrderRequest) (*ShipOrderResponse, error)
...
func (UnimplementedShippingServer) Ship(context.Context, *ShipOrderRequest) (*ShipOrderResponse, error) {
...
func _Shipping_Ship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShipOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServer).Ship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_Ship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServer).Ship(ctx, req.(*ShipOrderRequest))
	}
...
var Shipping_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ship",
			Handler:    _Shipping_Ship_Handler,
		},
	},
